...
2. Setup a robot, a warehouse, at least one warehouse, at least one workstation, one idle-station and at least one work order (If this is not done by specific software, it can easily be done by using dalma_feats.postman_collection.json which is provided by feats). In addition you can use the JSONs below
...
2. Let Visual Studio create a Socker-image
3. Use the image
